...
void EmployeeUI::handleEmployeeMenu() {
    int choice;
    do {
        displayMenu();
        std::cin >> choice;
...
void EmployeeUI::addEmployee() {
    std::string lastName, firstName, email, password, position, birthdate, abbreviation, remarks, isAdmin, birthDateString;
    float salary;
...
void EmployeeUI::modifyEmployee() {
    std::string firstName, lastName, email, password, position, birthdate, abbreviation, remarks, birthDateString, isAdmin, salary;
    float Salary;
